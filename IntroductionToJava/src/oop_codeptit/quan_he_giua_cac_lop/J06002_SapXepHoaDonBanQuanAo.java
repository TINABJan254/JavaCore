...
Output
Ghi ra danh sách hóa đơn được sắp xếp theo số tiền phải trả giảm dần gồm các thông tin (biết rằng không có 2 hóa đơn nào có số tiền bằng nhau).
Mỗi hóa đơn gồm các thông tin: Mã hóa đơn (đầy đủ).
Tên sản phẩm.
Số tiền giảm giá.
Số tiền phải trả.
